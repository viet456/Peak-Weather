(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))c(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&c(i)}).observe(document,{childList:!0,subtree:!0});function o(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function c(n){if(n.ep)return;n.ep=!0;const r=o(n);fetch(n.href,r)}})();async function T(e,t){if(e===void 0||t===void 0)return console.error("Latitude and longitude are required."),null;let o=`https://api.open-meteo.com/v1/forecast?latitude=${e}&longitude=${t}&forecast_days=10&current=temperature_2m,relative_humidity_2m,apparent_temperature,is_day,precipitation,weather_code,wind_speed_10m,wind_gusts_10m&hourly=temperature_2m,apparent_temperature,precipitation_probability,weather_code,wind_speed_10m,wind_gusts_10m,is_day&daily=weather_code,temperature_2m_max,temperature_2m_min,sunrise,sunset,uv_index_max,precipitation_sum,precipitation_probability_max,wind_speed_10m_max,wind_gusts_10m_max&past_days=1&timezone=auto`;try{let c=await fetch(o);if(!c.ok)throw new Error(`HTTP error! Status: ${c.status}`);let n=await c.json();return console.log(n),n}catch(c){return console.error("Failed to fetch weather data:",c),null}}const F="ccddd58ca0e545b3a0b058124c634360";async function U(e){if(!e)return null;let t=`https://api.geoapify.com/v1/geocode/search?text=${e}`;t+=`&type=city&limit=20&bias=countrycode:auto&format=json&apiKey=${F}`;try{let o=await fetch(t);if(!o.ok)throw new Error(`HTTP error! Status: ${o.status}`);let c=await o.json();return console.log(c.results),c.results||[]}catch(o){return console.error("Failed to fetch locations:",o),[]}}const E=["US","CA","AU","BR","IN"];function H(e){return typeof e!="string"||e===null?"":e.toUpperCase()}function O(e){if(!e||!e.city)return"";const{city:t,state:o,country_code:c,state_code:n}=e,r=H(c);return console.log(r),E.includes(r)&&o?`${t}, ${o}, ${r}`:`${t}, ${r}`}function B(e){if(!e||!e.city)return"";const{city:t,state:o,country_code:c,state_code:n}=e,r=H(c);return E.includes(r)&&o?`${t}, ${n}`:`${t}, ${r}`}function C(e,t={}){const{includeMinutes:o=!0}=t,c=new Date(e);if(!c||!(c instanceof Date)||isNaN(c.getTime()))return"Invalid time";const n={hour:"numeric"};return o&&(n.minute="2-digit"),c.toLocaleTimeString([],n)}function w(e,t){if(typeof e!="number")return"";const o=t==="imperial"?"fahrenheit":"celsius";let c=e;o==="fahrenheit"&&(c=e*9/5+32);let n=navigator.language||"en-US";return new Intl.NumberFormat(n,{style:"unit",unit:o,maximumFractionDigits:"0"}).format(Math.round(c))}function L(e,t){if(typeof e!="number")return"";const o=t==="imperial"?"mile-per-hour":"kilometer-per-hour";let c=e;o==="mile-per-hour"&&(c=e*.621371);let n=navigator.language||"en-US";return new Intl.NumberFormat(n,{style:"unit",unit:o,maximumFractionDigits:"0"}).format(Math.round(c))}function R(e,t){if(typeof e!="number")return"";const o=t==="imperial"?"inch":"millimeter";let c=e;o==="inch"&&(c=e/25.4);let n=navigator.language||"en-US";return new Intl.NumberFormat(n,{style:"unit",unit:o,maximumFractionDigits:1}).format(Math.round(c))}function W(e){let t=navigator.language||"en-US";return e.toLocaleString(t,{weekday:"short"})}const V={0:{text:"Clear Skies",icon:"sun"},1:{text:"Mainly Clear",icon:"sun"},2:{text:"Partly Cloudy",icon:"sun-cloud"},3:{text:"Overcast",icon:"cloud"},45:{text:"Foggy",icon:"fog"},48:{text:"Rime Fog",icon:"fog"},51:{text:"Light Drizzle",icon:"drizzle"},53:{text:"Drizzle",icon:"drizzle"},55:{text:"Heavy Drizzle",icon:"drizzle"},56:{text:"Light Freezing Drizzle",icon:"drizzle"},57:{text:"Freezing Drizzle",icon:"drizzle"},61:{text:"Light Rain",icon:"rain"},63:{text:"Rain",icon:"rain"},65:{text:"Heavy Rain",icon:"rain"},66:{text:"Light Freezing Rain",icon:"rain"},67:{text:"Freezing Rain",icon:"rain"},71:{text:"Light Snow",icon:"snow"},73:{text:"Snow",icon:"snow"},75:{text:"Heavy Snow",icon:"snow"},77:{text:"Snow Grains",icon:"snow"},80:{text:"Light Showers",icon:"rain"},81:{text:"Showers",icon:"rain"},82:{text:"Heavy Showers",icon:"rain"},85:{text:"Light Snow Showers",icon:"snow"},86:{text:"Heavy Snow Showers",icon:"snow"},95:{text:"Thunderstorm",icon:"thunderstorm"},96:{text:"Thunderstorm & Hail",icon:"thunderstorm"},99:{text:"Thunderstorm & Heavy Hail",icon:"thunderstorm"}};function _(e){const t=V[e];return t?t.text:"Weather data not available"}function $(e,t){if(!e)throw new Error("NO_DAILY_DATA: Daily data is missing.");if(!e.time)throw new Error("NO_TIME_ARRAY: Time array is missing in daily data.");if(!e.time[t])throw new Error(`INVALID_INDEX: No data for index ${t}.`);return{isDay:e.is_day[t],precipProbability:e.precipitation_probability[t],temperature:e.temperature_2m[t],date:new Date(e.time[t]),weatherCode:e.weather_code[t],windGusts:e.wind_gusts_10m[t],windSpeed:e.wind_speed_10m[t]}}function k(e,t){if(!e)throw new Error("NO_DAILY_DATA: Daily data is missing.");if(!e.time)throw new Error("NO_TIME_ARRAY: Time array is missing in daily data.");if(!e.time[t])throw new Error(`INVALID_INDEX: No data for index ${t}.`);return{date:new Date(e.time[t]),weatherCode:e.weather_code[t],tempMax:e.temperature_2m_max[t],tempMin:e.temperature_2m_min[t],sunrise:new Date(e.sunrise[t]),sunset:new Date(e.sunset[t]),uvIndexMax:e.uv_index_max[t],precipSum:e.precipitation_sum[t],precipProbabilityMax:e.precipitation_probability_max[t],windSpeedMax:e.wind_speed_10m_max[t],windGustsMax:e.wind_gusts_10m_max[t]}}function Y(e){const t=e.current;return{time:new Date(t.time),temperature:t.temperature_2m,apparentTemperature:t.apparent_temperature,isDay:t.is_day===1,precipitation:t.precipitation,humidity:t.relative_humidity_2m,weatherCode:t.weather_code,windSpeed:t.wind_speed_10m,windGusts:t.wind_gusts_10m}}function K(e){return k(e.daily,0)}function X(e){const t=e.daily,o=[];for(let c=0;c<t.time.length;c++){const n=k(t,c);n&&o.push(n)}return o}function Z(e){const t=e.hourly,o=[],c=new Date,n=t.time.findIndex(i=>new Date(i)>=c);if(n===-1)return[];const r=n+24;for(let i=n;i<r;i++){const s=$(t,i);s&&o.push(s)}return o}function J(e){const t=e.hourly;if(!t||!t.time)return[];const o=[],c={Morning:9,Afternoon:13,Evening:19,Overnight:22};for(const n in c){const r=c[n],i=t.time.findIndex(s=>new Date(s).getHours()===r);if(i!==-1){const s=$(t,i);s&&(s.name=n,o.push(s))}}return o}function S(e){var n;const t=e.weatherCode,o=e.isDay;let c=((n=V[t])==null?void 0:n.icon)||"unknown";return o&&((t===0||t===1)&&(c="moon"),t===2&&(c="moon-cloud")),c}const Q=`<?xml version="1.0" encoding="utf-8"?>
...
`,t0=`<svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 30 30" style="enable-background:new 0 0 30 30;" xml:space="preserve" fill="none" stroke="currentColor" stroke-width="1.5">
...
`,I=Object.assign({"../assets/icons/weather/cloud.svg":Q,"../assets/icons/weather/drizzle.svg":e0,"../assets/icons/weather/droplet-empty.svg":t0,"../assets/icons/weather/droplet-filled.svg":n0,"../assets/icons/weather/fog.svg":c0,"../assets/icons/weather/moon-cloud.svg":o0,"../assets/icons/weather/moon.svg":r0,"../assets/icons/weather/rain.svg":i0,"../assets/icons/weather/snow.svg":s0,"../assets/icons/weather/sun-cloud.svg":a0,"../assets/icons/weather/sun.svg":l0,"../assets/icons/weather/thunderstorm.svg":u0}),j={};for(const e in I){const t=e.split("/").pop().replace(".svg","");j[t]=I[e]}function d(e){return j[e]||""}function p0(e,t,o){const n=document.getElementById("current-weather-template").content.cloneNode(!0),r={location:n.querySelector(".js-current-location"),time:n.querySelector(".js-current-time"),temp:n.querySelector(".js-current-temp"),icon:n.querySelector(".js-current-icon"),text:n.querySelector(".js-current-text")},i=B(t),s=C(e.time),a=w(e.temperature,o),u=_(e.weatherCode),l=S(e),g=d(l);r.location.textContent=`${i}`,r.time.textContent=`As of ${s}`,r.temp.textContent=`${a}`,r.icon.innerHTML=g,r.text.textContent=u;const x=document.getElementById("current-weather-container");x.innerHTML="",x.append(n)}function d0(){const e=navigator.language||"en-US";let t;try{t=new Intl.Locale(e).region}catch{t="US"}return["US","BS","BZ","KY","LR","PW","FM","MH"].includes(t)?"imperial":"metric"}function v(){return localStorage.getItem("systemUnit")||d0()}function z(e){localStorage.setItem("systemUnit",e)}function m0(){const e=v();z(e==="metric"?"imperial":"metric")}function g0(e,t,o){const n=document.getElementById("today-details-template").content.cloneNode(!0),r={title:n.querySelector(".js-today-title"),forecast:n.querySelector(".js-today-forecast-text"),forecastIcon:n.querySelector(".js-today-forecast-icon"),highLow:n.querySelector(".js-today-high-low"),wind:n.querySelector(".js-today-wind"),sunrise:n.querySelector(".js-today-sunrise"),sunset:n.querySelector(".js-today-sunset"),precipProbability:n.querySelector(".js-today-precip-probability"),precipSum:n.querySelector(".js-today-precip-sum"),uvIndex:n.querySelector(".js-today-uv-index")},i=_(e.weatherCode),s=S(e),a=d(s),u=w(e.tempMax,o),l=w(e.tempMin,o),g=L(e.windSpeedMax,o),x=L(e.windGustsMax,o),h=C(e.sunrise),y=C(e.sunset),P=e.precipProbabilityMax,D=R(e.precipSum,o),A=e.uvIndexMax;r.title.textContent=`Weather Today in ${B(t)}`,r.forecast.innerHTML=`${i}`,r.forecastIcon.innerHTML=`${a}`,r.highLow.textContent=`${u} / ${l}`,r.wind.textContent=`${g} with gusts of ${x}`,r.sunrise.textContent=`${h}`,r.sunset.textContent=`${y}`,r.precipProbability.textContent=`${P}%`,r.precipSum.textContent=`${D}`,r.uvIndex.textContent=`${A}`;const b=document.getElementById("today-details-container");b.innerHTML="",b.append(n)}function w0(e,t){const c=document.getElementById("daily-item-template").content.cloneNode(!0),n={day:c.querySelector(".js-daily-day"),icon:c.querySelector(".js-daily-icon"),text:c.querySelector(".js-daily-forecast"),high:c.querySelector(".js-daily-high"),low:c.querySelector(".js-daily-low"),precipIcon:c.querySelector(".js-daily-precip-icon"),precipText:c.querySelector(".js-daily-precip-text")},r=new Date,i=e.date;let s;r.getFullYear()===i.getFullYear()&&r.getMonth()===i.getMonth()&&r.getDate()===i.getDate()?s="Today":s=W(i);const a=w(e.tempMax,t),u=w(e.tempMin,t),l=_(e.weatherCode),g=S(e),x=d(g),h=e.precipProbabilityMax;let y="";return h>=0&&(y=d("droplet-empty"),h>=30&&(y=d("droplet-filled"))),n.day.innerHTML=`${s}`,n.icon.innerHTML=`${x}`,n.text.textContent=l,n.high.textContent=a,n.low.textContent=u,n.precipIcon.innerHTML=`${y}`,n.precipText.textContent=`${h}%`,c}function x0(e,t,o){const n=document.getElementById("daily-forecast-template").content.cloneNode(!0),r=n.querySelector(".daily-forecast__items-container"),i=new Date,s=new Date(i.getFullYear(),i.getMonth(),i.getDate());e.forEach(u=>{if(u.date>=s){const l=w0(u,o);r.append(l)}});const a=document.getElementById("daily-forecast-container");a.innerHTML="",a.append(n)}function h0(e,t){const c=document.getElementById("hourly-item-template").content.cloneNode(!0),n={time:c.querySelector(".js-hourly-time"),temp:c.querySelector(".js-hourly-temp"),icon:c.querySelector(".js-hourly-icon"),text:c.querySelector(".js-hourly-description"),precipIcon:c.querySelector(".js-hourly-precip-icon"),precipText:c.querySelector(".js-hourly-precip-text")},r=C(e.date,{includeMinutes:!1}),i=w(e.temperature,t);_(e.weatherCode);const s=S(e),a=d(s),u=e.precipProbability;let l="";return u>=0&&(l=d("droplet-empty"),u>=30&&(l=d("droplet-filled"))),n.time.textContent=r,n.icon.innerHTML=`${a}`,n.temp.textContent=i,n.precipIcon.innerHTML=`${l}`,n.precipText.textContent=`${u}%`,c}function y0(e,t,o){const n=document.getElementById("hourly-forecast-template").content.cloneNode(!0),r=n.querySelector(".hourly-forecast__items-container");e.forEach(s=>{const a=h0(s,o);r.append(a)});const i=document.getElementById("hourly-forecast-container");i.innerHTML="",i.append(n)}function f0(e,t){const c=document.getElementById("period-item-template").content.cloneNode(!0),n={name:c.querySelector(".js-period-name"),temp:c.querySelector(".js-period-temp"),text:c.querySelector(".js-period-description"),icon:c.querySelector(".js-period-icon"),precipIcon:c.querySelector(".js-period-precip-icon"),precipText:c.querySelector(".js-period-precip-text")},r=e.name,i=w(e.temperature,t),s=_(e.weatherCode),a=S(e),u=d(a),l=e.precipProbability;let g="";return l>=0&&(g=d("droplet-empty"),l>=30&&(g=d("droplet-filled"))),n.name.textContent=r,n.temp.textContent=i,n.text.textContent=s,n.icon.innerHTML=`${u}`,n.precipIcon.innerHTML=`${g}`,n.precipText.textContent=`${l}%`,c}function v0(e,t,o){const n=document.getElementById("periods-forecast-template").content.cloneNode(!0),r=n.querySelector(".periods-forecast__list");e.forEach(s=>{const a=f0(s,o);r.append(a)});const i=document.getElementById("periods-forecast-container");i.innerHTML="",i.append(n)}const m=document.getElementById("search-results"),p=document.getElementById("search-input");document.getElementById("weather-container");const f=document.getElementById("unit-toggle-btn");let M=null,G=null;async function _0(e){if(!e)return null;if(m.innerHTML="",m.classList.remove("hidden"),e.length===0&&p.value!==""){m.innerHTML='<div class="location-result-item">No results found</div>';return}e.forEach(t=>{if(!t||!t.city)return;const o=document.createElement("div");o.classList.add("location-result-item"),o.textContent=O(t),o.addEventListener("mousedown",async()=>{q(t)}),m.append(o)})}async function S0(e){if(!e||e.length<2){m.classList.add("hidden"),m.innerHTML="",p.classList.remove("is-showing-results");return}const t=await U(e);p.classList.add("is-showing-results"),_0(t),console.log("API Search Results:",t)}async function q(e){M=e,p.value="",p.blur(),p.classList.remove("is-showing-results"),m.innerHTML="",m.classList.add("hidden");const t=await T(e.lat,e.lon);G=t,N(t,e)}function N(e,t){let o=v();const c=Y(e),n=K(e),r=X(e),i=Z(e),s=J(e);p0(c,t,o),g0(n,t,o),v0(s,t,o),y0(i,t,o),x0(r,t,o)}function C0(){v()==="metric"?f.textContent="C":f.textContent="F"}function M0(){C0(),f.addEventListener("click",()=>{m0(),v()==="metric"?f.textContent="C":f.textContent="F",console.log(v()),M&&N(G,M)});let e;p.addEventListener("input",o=>{clearTimeout(e),e=setTimeout(()=>{S0(o.target.value)},200)}),p.addEventListener("blur",()=>{p.classList.remove("is-showing-results"),m.classList.add("hidden")}),p.addEventListener("focus",()=>{p.value.length>2&&(p.classList.add("is-showing-results"),m.classList.remove("hidden"))}),T(37.77,122.41),q({city:"San Francisco",state_code:"CA",country:"United States",country_code:"us",lat:37.7749,lon:-122.4194})}M0();
